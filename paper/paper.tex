...
\begin{onecolabstract}
  ...
  July 15, 2012. We will see that DNSSEC penetration in the Internet's 
...
%% TODO this is not entirely true. The DNSKEYs are in the zone
%% itself. Only their signatures are in the parent zone.
\begin{enumerate}
...
%% TODO you cannot talk about TARs here without explaining. Reference
%% for this?
...
%% TODO what does this "plugin" do exactly?
...
%% TODO description about registrars is wrong. They do not host DNS entries.
...
%% TODO again: IP updates (except the Name Servers) don't go through 3R
...
%% TODO add part about computation

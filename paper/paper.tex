...
Again, this teardown must happen in a synchronous way, as resolvers will perceive the domain to be \emph{broken} as long as all involved parties are in a incoherent state.
